...
const MyBookings = () => {
  ...
  return (
    <div className=' py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        current, and upcoming hotel reservations in one place. Plan your 
        trips seemlessly with just few clicks' align='left'/>

        <div className='max-w-6xl mt-8 w-full text-gray-8000'> 
